...
class FallbackRealParser : IRealNumberParser
{
    ...
    public IEnumerable<char> Suffixes { get; } = Array.Empty<char>();
...
public class NumberParserHandler : INumberParserHandler
{
    ...
    private static ReadOnlyCollection<INumberParser> GetParsersFromAssembly(Assembly assembly) => assembly.GetTypesSafe()
    ...
    public static NumberParserHandler FromAssembly(Assembly assembly) => new(assembly == null ? _defaultParsers : GetParsersFromAssembly(assembly));
